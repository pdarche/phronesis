...
class MealIngredient(EmbeddedDocument):
	...
	monounsaturated_fat = FloatField()
	polyunsaturated_fat = FloatField()
	...
	serving_size_qty = FloatField()
	serving_size_unit = StringField()
	serving_weight_grams = FloatField()
	servings_per_container = FloatField()
	water_grams = FloatField()
	upc = IntField()
