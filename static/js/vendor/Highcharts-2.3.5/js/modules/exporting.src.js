...
var Chart = Highcharts.Chart,
	...
	extend(defaultOptions.lang, {
		...
		exportDataButton: 'Export data to CSV  (Data may be incomplete or contain inaccuracies.  Please contact L2 if you have any issues )'
	});
...
defaultOptions.exporting = {
	...
	buttons: {
		...
		// 	hoverSymbolFill: '#779ABF',
		// 	_id: 'printButton',
		// 	_titleKey: 'exportDataButton',
		// 	onclick: function () {
		// 		var i = 0
		// 	    var interval = setInterval(function(){
		// 	        if( i < TimeseriesView.clickedBenchmarks.length ) {
		// 	            url = 'http://l2-data.com/cmsx/output_csv.aspx?bid=' + TimeseriesView.clickedBenchmarks[i].brands
